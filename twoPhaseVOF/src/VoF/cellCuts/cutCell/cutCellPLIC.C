...
const Foam::DynamicList<Foam::label> Foam::cutCellPLIC::cutFaceLabels() const
{
    return cutFaceLabels_;
}

const Foam::DynamicList<Foam::label> Foam::cutCellPLIC::fullySubmergedFaceLabels() const
{
    return fullySubmergedFaceLabels_;
}

const Foam::DynamicList<Foam::label> Foam::cutCellPLIC::fullyNonSubmergedFaceLabels() const
{
    return fullyNonSubmergedFaceLabels_;
}

const Foam::DynamicList<Foam::point> Foam::cutCellPLIC::cutFaceCentres() const
{
    return cutFaceCentres_;
}

const Foam::DynamicList<Foam::vector> Foam::cutCellPLIC::cutFaceAreas() const
{
    return cutFaceAreas_;
}

const Foam::DynamicList<Foam::scalar> Foam::cutCellPLIC::cutFaceAreas2() const
{
